...
def assign_scores_to_stocks(accumulating_score_for_valuation_metric_weighting, all_stock_metric_values, weighting, indices_for_total_update=None):
   ...
   #if only one stock is being scored using normalisation, min-max normalisation cannot be applied because the normalisation range would be zero. Therefore, the stock's total is manually incremented by 0.5 points instead
